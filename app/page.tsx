...
export default function Home() {
  ...
  return (
    <main>
      ...
      <section className="collections" id="collections"><div className="section-index">01</div><div><span className="eyebrow">OUR COLLECTION</span><h2>Curated Styles <i>For Every You</i></h2><div className="collection-grid">{[["Party Wear","/black-maxi-dress.jpg"],["Bottom Wear","/bottom-wear.jpg"],["Top Wear","/top-wear.jpg"]].map(([x,img]) => <a className="collection-card" href="/shop" key={x}><img src={img} alt={x}/><strong>{x}</strong><span>Explore&nbsp; →</span></a>)}</div><a className="text-link" href="/shop">View all collections&nbsp; →</a></div></section>
